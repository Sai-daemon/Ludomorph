...
This product includes software developed by various third parties,
as listed below.
...
7. loguru
   Copyright (c) 2017-2020 Delgan
   License: MIT
   Source: https://github.com/Delgan/loguru

8. appdirs
   Copyright (c) ActiveState
   License: MIT
   Source: https://github.com/ActiveState/appdirs

9. onnxruntime
   Copyright (c) Microsoft Corporation
   License: MIT (primary), with Apache-2.0, BSL-1.0, and BSD-3-Clause components
   Source: https://github.com/microsoft/onnxruntime

10. Tesseract OCR
    Copyright (c) Hewlett Packard Laboratories Bristol and Google
    License: Apache-2.0
    Source: https://github.com/tesseract-ocr/tesseract

11. YOLOv11n (Ultralytics YOLO)
